    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Add Front Page Image</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html" class="text-success">Dashboard</a></li>
						 <li class="breadcrumb-item"><a href="index.html" class="text-success">Front Panel</a></li>
            ...
            <div class="card-body">
                ...
                <div class="form-body">
					 ...
					 <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input name="file" type="file" accept="image/*" class="form-control" placeholder="Select File" id="first-name-icon" required>              <div class="form-control-icon">
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary me-1 mb-1" name="add_image">Submit</button>
                    </div>
                    </div>
                </div>
                </form>
